<style lang="less">
	@import "./main.less";
	@import "../styles/myCommon.less";
	@import "../styles/bankCard.less";
</style>
<template>
						...
						<Row type="flex" justify="end" align="middle" class="user-dropdown-innercon">
							<Dropdown transfer trigger="click" @on-click="handleClickUserDropdown">
								...
								<DropdownMenu slot="list">
									<DropdownItem name="ownSpace">用户信息</DropdownItem>
									<DropdownItem name="editPassword">修改密码</DropdownItem>
									<DropdownItem name="editWithdrawalsPassword">修改提现密码</DropdownItem>
	...
	export default {
		...
		methods: {
			...
			handleClickUserDropdown(name) {
				...
				}else if(name === 'editWithdrawalsPassword') {
					this.$router.push({
