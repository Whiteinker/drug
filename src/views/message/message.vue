    ...
    methods: {
        ...
        getContent (index) {
            ...
            switch (this.currentMessageType + index) {
                case 'unread0': mesContent = '这是您点击的《欢迎登录药品配送后台管理系统，来了解他的用途吧》的相关内容。'; break;
                case 'unread1': mesContent = '这是您点击的《欢迎登录药品配送后台管理系统，来了解他的用途吧》的相关内容。'; break;
                case 'unread2': mesContent = '这是您点击的《欢迎登录药品配送后台管理系统，来了解他的用途吧》的相关内容。'; break;
                case 'hasread0': mesContent = '这是您点击的《欢迎登录药品配送后台管理系统，来了解他的用途吧》的相关内容。'; break;
                default: mesContent = '这是您点击的《欢迎登录药品配送后台管理系统，来了解他的用途吧》的相关内容。'; break;
            }
